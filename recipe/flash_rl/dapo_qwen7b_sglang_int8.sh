...
echo "gen_prompt_bs: ${gen_prompt_bsz}" 
...
# Set flash-rl
export FLASHRL_CONFIG=/mnt/public/share/open_source_model/FlashRL/qwen2.5-7b-instruct/flashrl_config.yaml
...
if [ ${RANK:-0} -eq 0 ]; then
    ...
    trainer.resume_mode=auto $@ 2>&1 | tee ${project_name}_${exp_name}.log
else
